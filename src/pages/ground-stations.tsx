...
const GroundStations: NextPage = () => {
    const {
        ...
        isLoading,
        refetch,
    } = api.groundStation.getGroundStations.useQuery();
    const { data: satellites } = api.satellite.getSatellites.useQuery();

    // Single ground station state
    const [currentStation, setCurrentStation] = useState<GroundStation | null>(
        null
    );
    ...
    const updateStationMutation =
        api.groundStation.updateGroundStation.useMutation({
            onSuccess: () => {
                setIsEditing(false);
                refetch();
            },
    ...
    const handleSaveStation = () => {
        if (!currentStation || !editedStation.name || !editedStation.location)
            return;
    ...
    const openTLEModal = () => {
        ...
        setNewTLE(
            currentStation.trackingSatellite?.tle || { line1: '', line2: '' }
        );
    ...
    return (
        <>
            <Head>
                <title>Ground Station - Rustar</title>
                <meta
                    name='description'
                    content='Ground station management and monitoring'
                />
                                    ...
                                    <div className='grid grid-cols-2 gap-4'>
                                        <div>
                                            ...
                                            {isEditing ? (
                                                ...
                                                <div className='text-white font-medium'>
                                                    {currentStation.location.latitude.toFixed(
                                                        6
                                                    )}
                                                    °
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            {isEditing ? (
                                                ...
                                                <div className='text-white font-medium'>
                                                    {currentStation.location.longitude.toFixed(
                                                        6
                                                    )}
                                                    °
                                                </div>
                                ...
                                {currentStation.trackingSatellite ? (
                                    ...
                                    <div className='text-center py-12 text-dark-400'>
                                        <div className='text-lg mb-2'>
                                            Sin satélite asignado
                                        </div>
                                        <div className='text-sm'>
                                            Haz clic en "Asignar Satélite" para
                                    ...
                                    <div>
                                        ...
                                        {selectedSatelliteId && (
                                            <p className='text-xs text-dark-400 mt-1'>
                                                Se cargará automáticamente el
                                                nombre y TLE del satélite
                                                seleccionado
                                            </p>
                                        )}
                                    </div>
