                        ...
                        <div className='space-y-8'>
                            ...
                            <div className='h-[600px]'>
                                <SatelliteMap
                                    ...
                                    selectedSatellite={
                                        selectedSatData?.id || null
                                    }
                                />
                            </div>

                            {/* Satellite Details - Full Width Card */}
                                ...
                                {isLoading ? (
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                                        ...
                                        <div className='space-y-4'>
                                            <h3 className='text-white font-medium text-sm uppercase tracking-wide border-b border-dark-700 pb-2'>
                                                Información Básica
                                            </h3>
                                            <div>
                                        ...
                                        <div className='space-y-4'>
                                            ...
                                            <div>
                                                ...
                                                <div className='text-white font-medium'>
                                                    {selectedSatData.position?.latitude.toFixed(
                                                        4
                                                    )}
                                                    °
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div className='text-white font-medium'>
                                                    {selectedSatData.position?.longitude.toFixed(
                                                        4
                                                    )}
                                                    °
                                                </div>
                                            ...
                                            <div className='space-y-4 lg:col-span-2'>
                                                ...
                                                <div className='mt-4'>
                                                    ...
                                                    <div className='text-dark-300'>
                                                        {selectedSatData.lastContact?.toLocaleString() ||
                                                            'No disponible'}
                                                    </div>
                                                </div>
                                                <button
                                                    ...
                                                    className='w-full bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-md font-medium transition-colors mt-4'
                                                >
                        ...
                        <div className='bg-dark-800 rounded-lg border border-dark-700 p-6 w-full max-w-2xl'>
                            ...
                            <div className='space-y-4'>
                                ...
                                <div>
                                    ...
                                    />
                                    <p className='text-xs text-dark-400 mt-1'>
                                        El nombre se obtiene automáticamente del
                                        TLE
                                    </p>
                                </div>
